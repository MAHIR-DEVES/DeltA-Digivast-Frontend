            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                ...
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                  Whether you have a clear vision or need creative guidance, we
                  are here to help. Contact us today to discuss your project and
                  discover how we can bring your ideas to life with our
