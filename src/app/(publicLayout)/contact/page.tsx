    ...
    <div className="min-h-screen transition-colors duration-300">
          ...
          <div className="text-center ">
            ...
            <div className="mb-4 md:mb-8 ">
              <h1 className="font-bold tracking-tight leading-[1.1] text-center">
                <span className="block text-gray-800 dark:text-gray-100 text-2xl sm:text-4xl md:text-5xl lg:text-6xl md:whitespace-nowrap">
                  Your Business in Rajshahi
                </span>
            ...
            <p className="text-gray-600 dark:text-gray-300 text-base text-sm md:text-xl max-w-2xl mx-auto leading-relaxed md:mb-10">
              Whatever your project or question — we reply within 24 hours.
              Let&apos;s start your digital journey together.
            </p>
          </div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-20 ">
        <div className="grid md:grid-cols-3 gap-6">
          {/* Phone Card */}
          <div className="p-8 bg-gray-50 dark:bg-white/5 rounded-xs border border-gray-100 dark:border-white/10 flex flex-col items-center text-center group hover:border-[#6efd0b]/50 transition-all">
      ...
      <section className="relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-8 flex items-center justify-center gap-2">
            <Clock size={16} />
            If you want to visit the studio.
          </p>
        </div>

        <div className="h-[400px] md:h-[700px] w-full relative">
          <iframe
            className="w-full h-full dark:invert-0"
